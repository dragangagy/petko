const CACHE_NAME = "petko-cache-v321";
...
// App shell must always come from network so API URL updates are not stuck in SW cache.
function isAppShellRequest(url) {
  return /\/(app\.js|index\.html|sw\.js)$/.test(url.pathname);
}
